        ...
        <div className="min-h-screen grid items-center justify-center p-4 bg-background/50 relative overflow-hidden">
            ...
            <div className="w-full max-w-[400px]">
                <div className="bg-card/60 backdrop-blur-2xl border shadow-2xl rounded-3xl p-8 relative overflow-hidden group hover:border-primary/30 transition-colors">
                    ...
                    <div className="flex flex-col items-center gap-4 mb-8">
                        ...
                        <div className="text-center">
                            <h1 className="text-2xl font-black bg-clip-text text-transparent bg-gradient-to-r from-foreground to-foreground/70">Bani Harun</h1>
                            <p className="text-sm font-semibold text-muted-foreground mt-1">Sertifikasi Sistem Informasi Keluarga</p>
                        </div>
                    </div>
                ...
                <div className="text-center mt-6">
                    <p className="text-xs font-bold text-muted-foreground tracking-wide opacity-50">Sistem Akses Tertutup • Bani Harun</p>
                </div>
            </div>
        </div>
    )
