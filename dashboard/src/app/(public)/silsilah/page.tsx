...
import { TreePine, Loader2, Printer, ChevronDown } from "lucide-react"
...
export default function FamilyTreePublicPage() {
...
function FamilyBranch({ member, allMembers, expandedNodes, onToggle }: {
    member: Member,
    allMembers: Member[],
...
function TreeNode({ member, hasChildren, isExpanded, onToggle }: {
    member: Member,
    hasChildren: boolean,
    isExpanded: boolean,
    onToggle: () => void
