...
export default function FamilyTreePage() {
    ...
    const fetchTreeData = async () => {
        ...
        if (data) {
            const formatted = data.map((item: any) => ({
                ...
                partnerBirthDate: item.family_biographies?.[0]?.partner_birth_date || "",
    ...
    const handleOpenEdit = useCallback((member: any) => {
        ...
        setFormData({
            ...
            partner_birth_date: member.partnerBirthDate || "",
                        ...
                        <form onSubmit={handleSubmit} className="grid gap-4 text-sm">
                            ...
                            <div className="grid gap-1.5">
                                ...
                                <div className="flex gap-2">
                                    <input placeholder="Nama pasangan..." value={formData.partner_name} onChange={e => setFormData({ ...formData, partner_name: e.target.value })} className="flex-1 h-11 px-4 bg-muted border rounded-xl focus:ring-2 focus:ring-primary/20 focus:outline-none" />
